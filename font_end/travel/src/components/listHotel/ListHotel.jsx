...
const ListHotel = () => {
    ...
    return (
        <>
            <div className='card'>
                <h1 className='font-bold text-3xl pt-5 mb-1'>Khách sạn giá sốc</h1>
                                ...
                                <div className='cardList-item m-2 '>
                                    ...
                                    <div className='cardHotel-bottom pl-2  '>
                                        <div className='flex mb-2'>
                                            ...
                                            <button className='ml-2 font-thin  bg-white text-pink-500 border-pink-400'>Khu nghỉ dưỡng</button>
                                        </div>
                                        <div className='flex'>
                                        ...
                                        <div className='flex justify-between border-dashed border-2 rounded-md border-slate-200 mb-3 mt-2 p-1 mr-2'>
                                            <div>
                                                <h2>Mã: <span className='text-blue-400'>DONNHE <button className='bg-blue-400'>-5%</button></span></h2>
                                            </div>
                                            <div>
